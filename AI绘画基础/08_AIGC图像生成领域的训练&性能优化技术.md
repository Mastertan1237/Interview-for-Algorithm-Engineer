...
- [1.AIGC图像生成领域主流的微调训练方法有哪些?](#1.AIGC图像生成领域主流的微调训练方法有哪些?)
- [2.AIGC图像生成大模型的训练流程都包含哪些步骤？](#2.AIGC图像生成大模型的训练流程都包含哪些步骤？)
- [3.AIGC图像生成大模型有哪些主流的训练框架？介绍其原理和功能](#3.AIGC图像生成大模型有哪些主流的训练框架？介绍其原理和功能)
- [4.图像生成领域主流的分布式训练技术有哪些？](#4.图像生成领域主流的分布式训练技术有哪些？)
- [5.介绍一下AIGC图像生成大模型的对齐训练原理](#5.介绍一下AIGC图像生成大模型的对齐训练原理)


### 第二章 AIGC图像生成领域的性能优化技术

- [1.Stable Diffusion的一些加速方法](#1.Stable-Diffusion的一些加速方法)
- [2.目前有哪些主流的AIGC图像生成大模型蒸馏方法？](#2.目前有哪些主流的AIGC图像生成模型大蒸馏方法？)


## 第一章 图像生成领域的主流训练技术正文

<h2 id="1.AIGC图像生成领域主流的微调训练方法有哪些?">1.AIGC图像生成领域主流的微调训练方法有哪些? </h2>


## 介绍一下图像生成领域的SFT训练的过程


## 介绍一下图像生成领域的RLHF训练的过程


## 介绍一下OFT(Orthogonal Finetuning)微调技术
...
<h2 id="2.AIGC图像生成大模型的训练流程都包含哪些步骤？">2.AIGC图像生成大模型的训练流程都包含哪些步骤？ </h2>
...
## Seedream的三阶段训练Pipeline都包含了哪些内容？ </h2>
...
<h2 id="3.AIGC图像生成大模型有哪些主流的训练框架？介绍其原理和功能">3.AIGC图像生成大模型有哪些主流的训练框架？介绍其原理和功能 </h2>


## 介绍一下Accelerate加速训练框架


## 介绍一下DeepSpeed加速训练框架


## 如何在Accelerate框架中使用DeepSpeed？


## 为什么有了Accelerate还需要DeepSpeed？


## DeepSpeed中Stage 1/Stage 2/Stage 3有哪些区别？


## 分布式训练框架DeepSpeed相较于Pytorch原生的torchrun有什么优点？


## 如何将训练代码迁移到Accelerate/DeepSpeed框架下？


<h2 id="4.图像生成领域主流的分布式训练技术有哪些？">4.图像生成领域主流的分布式训练技术有哪些？ </h2>

## 在DDP训练中，n_nodes，world_size，rank，local_rank，n_nodes，node_rank，nproc_per_node参数各代表什么含义？

<h2 id="5.介绍一下AIGC图像生成大模型的对齐训练原理">5.介绍一下AIGC图像生成大模型的对齐训练原理 </h2>
...
<h2 id="1.主流的AIGC图像生成大模型的推理加速技术有哪些？">1.主流的AIGC图像生成大模型的推理加速技术有哪些？</h2>
...
## 介绍一下Token Merging加速技术的原理


## 介绍一下TeaCache加速技术的原理


## 介绍一下wavespeed加速技术的原理


<h2 id="2.目前有哪些主流的AIGC图像生成大模型蒸馏方法？">2.目前有哪些主流的AIGC图像生成大模型蒸馏方法？</h2>
